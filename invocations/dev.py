__all__ = ["build_docs", "build_public_image", "clean", "install", "lint"]
...
@task(name="build-docs", pre=(install,))
def build_docs(ctx: Context, version: str = "", output: str = "") -> None:
    ...
    ctx.run(f"python deploy/build_docs.py {' '.join(args)}")
