...
class TableGroup(Entity):
    ...
    contract_version: str | None = Column(NullIfEmptyString)   # DEPRECATED — use data_contracts.version
    contract_status: str | None = Column(String, default="draft")  # DEPRECATED — unused in versioned model
    contract_stale: bool | None = Column(Boolean, default=False)
    last_contract_save_date: datetime | None = Column(postgresql.TIMESTAMP(timezone=True))
