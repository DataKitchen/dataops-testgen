...
class TestSuite(Entity):
    ...
    is_contract_suite: bool = Column(Boolean, default=False)
    ...
    def select_summary(cls, project_code: str, table_group_id: str | UUID | None = None, test_suite_name: str | None = None) -> Iterable[TestSuiteSummary]:
        ...
        SELECT
            ...
            COALESCE(suites.is_contract_suite, FALSE) AS is_contract_suite,
            ...
            EXISTS (
                ...
                WHERE table_group_id = suites.table_groups_id
            ) AS has_contract
        ...
        LEFT JOIN data_contracts AS dc
