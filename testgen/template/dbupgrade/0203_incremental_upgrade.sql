...
ALTER TABLE profile_results
    ADD COLUMN IF NOT EXISTS frequent_values JSONB,
    ADD COLUMN IF NOT EXISTS frequent_patterns JSONB;
...
ALTER TABLE profile_results
    DROP COLUMN IF EXISTS top_freq_values,
    DROP COLUMN IF EXISTS top_patterns;
