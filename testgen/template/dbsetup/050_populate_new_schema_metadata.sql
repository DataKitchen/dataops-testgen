...
VALUES  ('Standard', 'Alpha_Trunc'),
        ('Standard', 'Avg_Shift'),
        ('Standard', 'Constant'),
        ('Standard', 'Daily_Record_Ct'),
        ('Standard', 'Dec_Trunc'),
        ('Standard', 'Distinct_Date_Ct'),
        ('Standard', 'Distinct_Value_Ct'),
        ('Standard', 'Email_Format'),
        ('Standard', 'Future_Date'),
        ('Standard', 'Future_Date_1Y'),
        ('Standard', 'Incr_Avg_Shift'),
        ('Standard', 'LOV_Match'),
        ('Standard', 'Min_Date'),
        ('Standard', 'Min_Val'),
        ('Standard', 'Missing_Pct'),
        ('Standard', 'Monthly_Rec_Ct'),
        ('Standard', 'Outlier_Pct_Above'),
        ('Standard', 'Outlier_Pct_Below'),
        ...
        ('Standard', 'Unique'),
        ('Standard', 'Unique_Pct'),
        ('Standard', 'Valid_Characters'),
        ('Standard', 'Valid_Month'),
        ('Standard', 'Valid_US_Zip'),
        ('Standard', 'Valid_US_Zip3'),
