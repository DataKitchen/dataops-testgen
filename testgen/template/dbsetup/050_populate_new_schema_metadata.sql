...
VALUES  ('measure', 'meter|m|metre'),
        ...
        ('med_dose', 'treatment|trx|tx'),
        ('med_dose', 'new patients|new patient|new pt|nrx'),
        ('med_dose', 'prescription|rx'),
        ('inv_uom', 'each|ea'),
