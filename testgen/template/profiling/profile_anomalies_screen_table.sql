INSERT INTO profile_anomaly_results
   (project_code, table_groups_id, profile_run_id, anomaly_id,
    schema_name, table_name, column_name, detail, disposition, impact_dimension)
...
INNER JOIN profile_anomaly_types at ON at.id = :ANOMALY_ID
...
GROUP BY p.project_code, p.table_groups_id, p.profile_run_id,
         p.schema_name, p.table_name, at.impact_dimension
