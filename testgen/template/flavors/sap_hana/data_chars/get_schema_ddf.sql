WITH relations AS (
    SELECT SCHEMA_NAME, TABLE_NAME, COLUMN_NAME, DATA_TYPE_NAME, LENGTH, SCALE, POSITION,
           'TABLE' AS object_type
    FROM SYS.TABLE_COLUMNS
    WHERE SCHEMA_NAME = '{DATA_SCHEMA}'
    UNION ALL
    SELECT SCHEMA_NAME, VIEW_NAME AS TABLE_NAME, COLUMN_NAME, DATA_TYPE_NAME, LENGTH, SCALE, POSITION,
           'VIEW' AS object_type
