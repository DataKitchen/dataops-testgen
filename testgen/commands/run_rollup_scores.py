...
def run_profile_rollup_scoring_queries(run_id: str, table_group_id: str | None = None):
    ...
    RunActionQueryList("DKTG", queries)


def run_test_rollup_scoring_queries(run_id: str, table_group_id: str | None = None):
