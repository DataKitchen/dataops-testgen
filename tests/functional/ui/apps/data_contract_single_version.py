...
Like data_contract_saved_version.py but with only ONE version.
Used to test:
...
_patches = [
    ...
    # Only ONE version in the list — key difference from saved_version fixture
    patch("testgen.ui.views.data_contract.list_contract_versions", return_value=[VERSION_0]),
    ...
    patch("testgen.ui.views.dialogs.data_contract_dialogs.save_contract_version", return_value=1),
